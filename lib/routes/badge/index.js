...
router.get('/badge/version/:org/:repo/:size/:rx/:fg1/:bg1/:fg2/:bg2', async (ctx) => {
  const org = ctx.params.org
  const repo = ctx.params.repo
  const request = await axios.get(`https://raw.githubusercontent.com/${org}/${repo}/master/package.json`)
